--[[
    ...
    🐺 LXR Core - Scoreboard System | Client Script
    ...
    while true do
        ...
        if IsControlJustReleased(0, Config.OpenKey)  then  -- Config Keybind
            if not scoreboardOpen then
                exports['lxr-core']:TriggerCallback('lxr-scoreboard:server:GetPlayersArrays', function(playerList)
                    exports['lxr-core']:TriggerCallback('lxr-scoreboard:server:GetActivity', function(cops, ambulance)
